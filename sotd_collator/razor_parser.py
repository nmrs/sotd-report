...
class RazorParser(BaseParser):
    ...
    @cached_property
    def _razors_from_yaml(self):
        with open(f"{os.getcwd()}/sotd_collator/razors.yaml", "r") as f:
    ...
    def __mapper(self):
        ...
        for brand, model_map in self._razors_from_yaml.items():
...
if __name__ == "__main__":
    ...
    # with open(f"{os.getcwd()}/sotd_collator/razors.yaml", "w") as f:
    #     yaml.dump(rp._raw, f, default_flow_style=False, Dumper=CustomDumper)

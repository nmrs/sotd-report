...
class BrushAlternateNamer(BaseAlternateNamer):
    ...
    apply_first = {
        ...
        "Declaration Grooming B11": ["b11"],
        "Declaration Grooming B12": ["b12"],
        "Declaration Grooming B13": ["b13"],
        "Declaration Grooming B14": ["b14"],
        "Declaration Grooming B15": ["b15"],
        "Declaration Grooming B16": ["b16"],
        "Declaration Grooming B17": ["b17"],
        "Declaration Grooming B18": ["b18"],
        ...
        "Semogue SOC Mixed Badger/Boar": [
            r"^(semogue\s*)*s\.*o\.*c\.*.*badg.*boar",
            r"^(semogue\s*)*s\.*o\.*c\.*.*boar.*badg",
            "soc.*mix",
            "owner.*bad.*boa",
            "owner.*boa.*bad",
            "semogue.*mistura",

...
class BrushAlternateNamer(BaseAlternateNamer):
    ...
    standard_makers = {
        ...
        'B&M': {'patterns': ['b\s*&\s*m', 'barrister'], 'default': 'Synthetic'},
        ...
        'Bristle Brushwerks': {'patterns': ['huck'], 'default': 'Badger'},
        ...
        'Razorock': {'patterns': ['Razorr*ock', '(^|\s)rr\s', 'plissoft'], 'default': 'Synthetic'},

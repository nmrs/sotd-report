...
class RazorAlternateNamer(BaseAlternateNamer):
    ...
    _raw = OrderedDict({
        ...
        'Broman Razor': ['broman'],
        'Cartridge / Disposable': ['cartridge', 'disposable', 'atra', 'mach\s*(3|iii)', ],
        ...
        'Ever Ready 1924': ['(ever|er).*1924', '1924.*(ever|er)', 'shovel\s*head'],
        ...
        'GEM Clog Pruf': ['gem.*clog'],
        'GEM Damaskeene': ['gem.*damas'],
        'GEM Featherweight': ['gem.*(feather)'],
        'GEM G-Bar': ['gem.*g.*bar'],
        'GEM Junior': ['gem.*(junior|jr)'],
        'GEM Micromatic Open Comb': ['gem.*(micromatic|mmoc|ocmm)', 'mmoc', 'ocmm'],

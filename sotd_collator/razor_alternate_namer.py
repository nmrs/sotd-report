    ...
    _raw = OrderedDict(
        {
            ...
            "Above the Tie M1": [
                "ATT.*m-*1",
                "tie.*m-*1",
                "(atlas|bamboo|calypso|colossus|kronos).*m1",
            ],
            "Above the Tie M2": [
                "ATT.*m-*2",
                "tie.*m-*2",
                "(atlas|bamboo|calypso|colossus|kronos).*m2",
            ],
            "Above the Tie R1": [
                "ATT.*r-*1",
                "tie.*r-*1",
            ...
            "Bevel Razor": ["bevel"],
            "Blackland Blackbird": [r"black\s*bird", r"bb\s*(sb|oc)", "brassbird"],
            "Blackland Era": ["black.*era", r"\Wera\W"],
            "Blackland Dart": [r"(^|\s)dart"],
            "Blackland Sabre": ["sabre"],
            "Blackland Vector": ["vector"],
            "Blutt Rasur BR-1": ["blutt"],
            "Boker Straight": [r"Boker(\s+straight)*"],
            "Broman Razor": ["broman"],
            ...
            "Dorco ST-301": ["ST-*301"],
            "Dorco PL-602": ["pl-*602"],
            "Dovo Straight": [r"dovo(\s+straight)*"],
            "Edwin Jagger DE89": [
                r"DE\s*89",
                "kelvin",
                "edwi",
            ...
            "Ever Ready Streamline": [r"(ever|er).*stream\s*line", r"^stream\s*line$"],
            ...
            "Filarmonica Straight": [r"Filar*monica(\s+straight)*"],
            ...
            "Koraat Straight": [r"Koraat(\s+straight)*"],
            ...
            "'Merica Razor": [r"('|\s|^)merica"],
            "Merkur 15C": ["15c"],
            "Merkur 23C": ["23c"],
            "Merkur 24C": ["24c"],
            "Merkur 33C": [r"33\(*c"],
            "Merkur 34C": [r"34\(*(c|g)", "merk.*hd", "^HD$"],
            # "Merkur 34G": ["34g"], # 34G is just a color variety of 34C so collapse them
            ...
            "EldrormR Industries MM24": [r"mm\s*24"],
            "Mongoose": ["goose"],
            "Mongoose Alumigoose": ["alumigoose"],
            "Muhle Companion": ["companion"],
            "Muhle R41": ["R41"],
            "Muhle R89": [r"R10\d", "R89", "muhle.*89"],
            "Muhle Rocca": ["rocca"],
            "Noble Otter DE": ["NOC(1|2)", "NO(1|2)C", r"NOB\d", r"nobc\d"],
            ...
            "PILS": ["pils.*10", "^pils$"],
            "Portland Razor Co. Straight": [r"portland.*razor(\s+straight)*"],
            "QShave Parthenon": ["parthenon"],
            "Ralf Aust Straight": [r"ralf.*aust(\s+straight)*"],
            ...
            "Rex Ambassador": ["rex.*ambassador", "ambassador.*rex", r"rex.*\d"],
            "Rex Envoy": ["envoy"],
            ...
            "Schick Hydromagic": [r"hydro[\-\s]*magic"],
            "Schick Injector": [
                "Schick.*Injector",
                "schick.*type",
                "golden.*500",
            ...
            "WCS/Charcoal Goods - El Capitan": [r"el\s*capitan"],
            "WCS/Charcoal Goods - Hyperion": ["hyperion"],
            "WCS/Charcoal Goods - Hollywood Palm": ["hollywood.*palm"],
            "WCS Multi Titanium Collection Razor": [
                "(WCS|West Coast Shaving).*titanium"
            ],
            "Weber ARC": ["weber.*arc"],
            "Weber DLC": ["weber.*dlc"],
            "Weber PH": ["weber.*ph"],
            ...
            "Wolfman WR2": ["Wolfman.*WR-*2", "WR-*2"],
            "Wolfman WR3": ["Wolfman.*WR-*3", "WR-*3"],
            "Yates 921": [r"921-*\w", "(yates|ypm).*921", "921.*yates"],
            "Yates BYOR": [r"Yates\s(?!Winning|Merica|921)\S+\s(M|E|EH)"],

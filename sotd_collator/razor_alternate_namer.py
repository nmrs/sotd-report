...
class RazorAlternateNamer(BaseAlternateNamer):
    ...
    _raw = OrderedDict({
        ...
        'Phoenix Artisan Accoutrements Alpha Ecliptic': ['alpha.*ecli'],
        'Phoenix Artisan Accoutrements Bakelite Slant': ['(phoenix|paa).*bake.*slant'],
        'Phoenix Artisan Accoutrements DOC': ['(phoenix|paa).*doc', '(phoenix|paa).*double.*comb'],
        ...
        'West Coast Shaving 77': ['77-*S', 'WCS.*77'],
        'West Coast Shaving 78': ['78-*BL', '78M', 'WCS.*78'],
        'West Coast Shaving 84': ['84-*R*B', 'WCS.*84'],
        'West Coast Shaving 88': ['88-*S', 'WCS.*88', '(wcs|west).*78'],
        'West Coast Shaving/Charcoal Goods - El Capitan': ['el\s*capitan'],
        'West Coast Shaving/Charcoal Goods - Hyperion': ['hyperion'],
        'West Coast Shaving/Charcoal Goods - Hollywood Palm': ['hollywood.*palm'],
        'West Coast Shaving Multi Titanium Collection Razor': ['(WCS|West Coast Shaving).*titanium'],
        'Weber ARC': ['weber.*arc'],
        'Weber DLC': ['weber.*dlc'],
        'Weber PH': ['weber.*ph'],

...
class RazorAlternateNamer(BaseAlternateNamer):
    ...
    _raw = OrderedDict({
        ...
        'West Coast Shavin 77': ['77-*S', 'WCS.*77'],
        'West Coast Shavin 78': ['78-*BL', '78M', 'WCS.*78'],
        'West Coast Shavin 84': ['84-*R*B', 'WCS.*84'],
        'West Coast Shavin 88': ['88-*S', 'WCS.*88', '(wcs|west).*78'],
        'West Coast Shavin/Charcoal Goods - El Capitan': ['el\s*capitan'],
        'West Coast Shavin/Charcoal Goods - Hyperion': ['hyperion'],
        'West Coast Shavin/Charcoal Goods - Hollywood Palm': ['hollywood.*palm'],
        'West Coast Shavin Multi Titanium Collection Razor': ['(WCS|West Coast Shaving).*titanium'],
        'Weber ARC': ['weber.*arc'],
        'Weber DLC': ['weber.*dlc'],
        'Weber PH': ['weber.*ph'],

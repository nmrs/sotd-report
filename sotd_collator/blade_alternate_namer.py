...
class BladeAlternateNamer(BaseAlternateNamer):
    ...
    _raw = OrderedDict({
        ...
        'Aeterna': ['aeter'],
        'Astra Superior Platinum (Green)': ['astra.*plat', 'astra.*green', 'astra.*sp', 'astra'],
        'Astra Superior Stainless (Blue)': ['astra.*sta', 'astra.*blue', 'astra.*ss'],
        ...
        'Gillette Silver Blue': ['gsb', 'Gill.*sil.*blue', 'silver.*blue', 'gill.*sb', 'gill.*blu.*sil'],

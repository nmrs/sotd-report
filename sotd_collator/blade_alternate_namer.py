    ...
    _raw = OrderedDict(
        {
            ...
            "AccuTec Pro Premium (GEM)": ["acc?utec"],
            "Aeterna": ["aeter"],
            ...
            "Bolzano": ["b(o|a)lzano"],
            "Crystal": ["crystal"],
            "Derby Blue Bird": ["blue.*bird"],
            "Derby Concord": ["concord"],
            ...
            "Kai Captain Blade (AC)": ["kai.*blade", r"kai captain\s*$"],
            "Kai Captain Sharpblade (AC)": ["kai.*sharp"],
            "Kai Captain Titan Mild (AC)": ["kai.*titan", "kai.*cap.*"],
            ...
            "Personna 74": [r"p(?:ersonn*a)?\s*74", "pseventy-four", "p74"],
            ...
            "Shaving Revolution Platinum": ["shaving\s*revolution"],
            ...
            "Tatra Platinum": ["tatra"],
            "Ted Pella Injector": ["pella"],
            "Tiger Platinum": ["tiger"],
            "Treet Black Beauty": ["treet\s*bla"],
            "Treet Classic": ["treet.*classic"],
